---
title: "Analysis of NMFS Consultations"
...
fluidPage(
  fluidRow(
    column(6,
           p("The U.S. Endangered Species Act (ESA) requires that federal agencies consult with the U.S. Fish and Wildlife Service or National Marine Fisheries Service (NMFS) to ensure federal actions do not jeopardize the existence of listed species. In a recent", tags$a("paper", href = 'https://www.biorxiv.org/content/10.1101/424911v1.article-info')," We analyzed all the consultations recorded by NMFS from 2000–2017 to understand how this important part of the ESA is implemented, and to investigate the role of expert review and analysis in the consultation process.")
           ),
    column(1),
    column(5,
           img(src = 'Box1.png', width = 400, height = 400, alt = 'Conceptual diagram of the section 7 consultation process under the Endangered Species Act')
           )
...
fluidPage(
  ...
  fluidRow(
    p("Many agencies agreed with NMFS. However, our analyses revealed that NMFS disagreed with some agencies more frequently than others - with some agencies regularly overestimating, and others regularly underestimating the effect of their actions on listed species.")
  )
)
```
...
fluidPage(
  fluidRow(
    ...
    column(2, 
           div(
             br(),
             p("Different listed species were jeopardized by different types of proposed actions.  This heatmap illustrates which combinations of work types and species resulted in more (yellow) or fewer (purple) jeopardy determinations than would be expected by random chance.")
           )
    )
  )
)
